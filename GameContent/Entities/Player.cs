    ...
    public class Player : WorldObject, IRendering
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            switch (State)
            {
                ...
                {
                    Transform.Rotation += 10f * Time.FixedDeltaTime;
                    ...
                    if (_upgradeTimer <= 0)
                    {
                        ...
                        GameCenter.GameObjects.Add(new ParticleSystem(GameCenter, new Transform(Transform.Position, Transform.Scale, Transform.Rotation), "PlayerUpgradeParticle", data));
                    }
                    break;
                }
                default:
